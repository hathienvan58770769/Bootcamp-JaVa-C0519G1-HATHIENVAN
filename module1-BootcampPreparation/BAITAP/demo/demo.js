...
function sqMouseOver(row, col) {
	if (gamming && sq[row][col] == 0 && Turn == X) {
		var HTML='<img style="opacity: 0.5" src="https://raw.githubusercontent.com/vietanhdev/van-caro-online/master/img/x.png">';
...
function sqUpdate(i,j){
	var OHtml='<img src="https://raw.githubusercontent.com/vietanhdev/van-caro-online/master/img/o.png">';
	var XHtml='<img src="https://raw.githubusercontent.com/vietanhdev/van-caro-online/master/img/x.png">';
	if (sq[i][j] == O){
